...
# Usage: ./run_cv_sdpo_all.sh [--dry-run]
...
for DATA_PATH in "${DATA_PATHS[@]}"; do
    ...
    EXP_NAME="FINAL-CV_SDPO-train${TRAIN_BATCH_SIZE}-alpha${ALPHA}-gamma${CV_GAMMA}-beta${BETA_MODE}-rollout${ROLLOUT_BATCH_SIZE}-lr${LR}-dross${DONTS_REPROMPT_ON_SELF_SUCCESS}-${MODEL_NAME}"
