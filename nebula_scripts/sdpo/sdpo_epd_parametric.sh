#!/usr/bin/env bash
# =============================================================================
# SDPO + EPD 参数化训练脚本（供 Nebula sweep 调用）
# 基于 sdpo_sciknoweval_parametric.sh，增加 EPD 特有参数
...
save_path="${LOG_ROOT}/models/${JOB_NAME:-sdpo_epd_sweep}"
...
python -m verl.trainer.main_ppo \
    ...
    trainer.project_name="${PROJECT_NAME:-TASD_EPD}" \
    trainer.experiment_name="${JOB_NAME:-sdpo_epd_sweep}" \
    trainer.group_name="SDPO-EPD" \
